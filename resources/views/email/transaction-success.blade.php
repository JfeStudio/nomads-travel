        ...
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="border-bottom:1px dashed #fafafa;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0;text-align:center;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center"
                                                                style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;">
                                                                <div
                                                                    style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#000000;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #fafafa;vertical-align:top;padding:5px;">
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    role="presentation" style="" width="100%">
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    border="0"
                                                                    style="color:#000000;font-family:Asistant, Helvetica, Arial, sans-serif;font-size:14px;line-height:23px;table-layout:auto;width:100%;border:none;">
                                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" vertical-align="middle"
                                                                style="font-size:0px;padding:20px 25px 30px;word-break:break-word;">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    role="presentation"
                                                                    style="border-collapse:separate;line-height:100%;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#f9a826"
                                                                                role="presentation"
                        ...
                        <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="vertical-align:top;padding:15px 0 0;">
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    role="presentation" style="" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    style="font-family:Asistant, Helvetica, Arial, sans-serif;font-size:14px;font-weight:bold;line-height:1;text-align:left;color:#000000;">
                                                                    Butuh Bantuan?</div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width: 20px">
                                                            <img src="{{ asset('frontend/assets/images/ic_bahasa@2x.png') }}"
                                                                alt="Nomads Logo" align="left" border="none"
                                                                padding="0px" />
                                                        </td>
                                                        <td style="font-size: 14px; padding-left: 10px">
                                                            support@nomads.id <br /> +62 21 2208 1996 </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <div
                                                                    style="font-family:Asistant, Helvetica, Arial, sans-serif;font-size:13px;font-weight:semibold;line-height:1;text-align:center;color:#111111;">
                                                                    © 2023 Created By Nomads All Rights Reserved.</div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
